...
@pytest.mark.parametrize("query, set_translated_attr",
                         [(QueryMeasurementTimeseriesTVP(monitoring_feature=['A-9237'], observed_property=['Ag'], start_date='2019-01-01'),
                          ...
                          (QueryMeasurementTimeseriesTVP(monitoring_feature=['9237'], observed_property=['Ag'], start_date='2019-01-01'),
                           {'monitoring_feature': []}),
                          (QueryMeasurementTimeseriesTVP(monitoring_feature=[(-99.6, 34.1, -99.4, 34.3), (-100.4, 38.5, -100.3, 38.7)], observed_property=['Ag'], start_date='2019-01-01'),
                           {'monitoring_feature': [(-99.6, 34.1, -99.4, 34.3), (-100.4, 38.5, -100.3, 38.7)]}),
                          (QueryMeasurementTimeseriesTVP(monitoring_feature=['A-9237-AX', (-100.4, 38.5, -100.3, 38.7), 'F-abc'], observed_property=['Ag'], start_date='2019-01-01'),
                           {'monitoring_feature': ['9237-AX', (-100.4, 38.5, -100.3, 38.7)]}),
