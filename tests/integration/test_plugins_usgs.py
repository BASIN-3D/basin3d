...
from basin3d.core.types import SamplingMedium, FeatureTypes, TimeFrequency, ResultQuality
...
def test_usgs_monitoring_features2(query, expected_count, monkeypatch):
    ...
    for mf in monitoring_featurues:
        count += 1
        print(FeatureTypes.TYPES[mf.feature_type])
        print(query['feature_type'].upper())
        print(
